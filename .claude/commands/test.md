...
6. For type or integration changes, run `npm run lint` and `npm run build`.
7. Report which acceptance criteria were directly exercised and which still rely on reasoning only.
...
- `npm run test:e2e` once Playwright is added
